  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-black flex flex-col">
      ...
      <div className="flex-grow flex justify-center items-center px-4 pt-24">
        <div className="bg-gray-900/80 border border-cyan-300/20 backdrop-blur-md shadow-2xl rounded-2xl w-full max-w-md p-8">
          <div className="text-center mb-6">
            ...
            <h1 className="text-2xl font-semibold mt-4 text-white">Welcome Back</h1>
            <p className="text-sm text-gray-300 mt-2">Log in to continue managing rentals and bookings.</p>
          </div>
